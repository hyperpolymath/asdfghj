...
:experimental:
:url-github: https://github.com/hyperpolymath/asdf-ghjk
:url-gitlab: https://gitlab.com/hyperpolymath/asdf-ghjk
:url-bitbucket: https://bitbucket.org/hyperpolymath/asdf-ghjk
:url-codeberg: https://codeberg.org/hyperpolymath/asdf-ghjk

Extended ASDF plugin management utilities
...
asdf-ghjk is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
